...
namespace SimpleZaifTrader
{
    public static class Global
    {
        ...
        public static string GetOrderBookFormat(CurrencyPairSettings settings)
        {
            ...
            {
                case 1:
                    return "{0, 10:####0.0000} {1, 13:#######0.0000} | {2, 10:####0.0000} {3, 13:#######0.0000} || {4} {5} {6, 10:####0.0000} {7, 13:#######0.0000}";
                case 2:
                    return "{0, 10:#######0.0} {1, 13:#######0.0000} | {2, 10:#######0.0} {3, 13:#######0.0000} || {4} {5} {6, 10:#######0.0} {7, 13:#######0.0000}";
                case 3:
                    return "{0:0.00000000} {1, 13:#######0.0000} | {2:0.00000000} {3, 13:#######0.0000} || {4} {5} {6:0.00000000} {7, 13:#######0.0000}";
                default:
                    return "{0, 10} {1, 13:#######0.0000} | {2, 10} {3, 13:#######0.0000} || {4} {5} {6, 10} {7, 13:#######0.0000}";
            }
        }
        ...
        public static string GetLastPriceFormat(CurrencyPairSettings settings)
        {
            ...
            {
                case 1:
                    return "          最終取引価格: {0:0.00000000} BTC";
                default:
                    return "          最終取引価格: {0, 10} JPY ({1:#######0.00} USD  @{2:##0.000} USD/JPY)";
            }
        }
    }
}
